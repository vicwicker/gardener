	...
	var (
		...
		generateAndReplicateGlobalObservabilityIngressPassword = g.Add(flow.Task{
			...
			Fn: func(ctx context.Context) error {
				...
				// accept empty last-rotation-initiation-time label values for brand new generated secrets, but fail for any other content that cannot be parsed as an integer
